                    ...
                    <td class="quantity">
                        <div class="input-group btn-block" style="max-width: 200px;">
                            ...
                            <span class="input-group-btn">
                                <button class="btn btn-primary" data-onclick="changeProductQuantity" data-toggle="tooltip" type="submit" title="<?php echo $button_update; ?>">
                                    <i class="fa fa-refresh"></i>
                                </button>
                                <button class="btn btn-danger" data-onclick="removeProduct" data-product-key="<?php echo !empty($product['cart_id']) ? $product['cart_id'] : $product['key'] ?>" data-toggle="tooltip" type="button" title="<?php echo $button_remove; ?>">
