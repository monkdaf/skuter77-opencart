...
<span itemscope itemtype="http://schema.org/LocalBusiness"><div itemprop="telephone" id="cart_block1">
+7 (499) 705-88-38
</div></span>		
							     <!-- Search -->
	...
	<!-- Slider -->
<noindex>	<div id="slider" class="<?php if($theme_options->get( 'slideshow_layout' ) == 1) { echo 'full-width'; } elseif($theme_options->get( 'slideshow_layout' ) == 4) { echo 'fixed3 fixed2'; } elseif($theme_options->get( 'slideshow_layout' ) == 3) { echo 'fixed2'; } else { echo 'fixed'; } ?>">
