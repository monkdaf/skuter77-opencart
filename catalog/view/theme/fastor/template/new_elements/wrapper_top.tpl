				               ...
				               <div class="col-md-6 hidden-xs hidden-sm">
				                    <?php if(is_array($product_prev_next['prev'])) { ?>
     				                    ...
     				                    <div class="next-product-2 clearfix">
											 <a class="button-previous-next" href="javascript:history.back();">Назад</a>
     				                    </div>
     				                    <?php } else { ?>
     				                    <div class="next-product clearfix">
     				                              <a class="button-previous-next" href="javascript:history.back();">Назад</a></a>
     				                    </div>
     				                    <?php } ?>
				                    <?php } ?>
				               </div>
