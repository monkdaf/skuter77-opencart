...
class ControllerModuleShopRatingVertical extends Controller {
    ...
    public function index() {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/shop_rating_vertical.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/template/module/shop_rating_vertical.tpl', $data);
        } else {
            return $this->load->view('default/template/module/shop_rating_vertical.tpl', $data);
        }
