...
class ControllerModuleFilterPro extends Controller {
	...
	public function index() {
		...
		$licensed = $this->model_module_filterpro->getLicense();
		if (!$licensed){
		...
		if(($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate() && $licensed) {
		...
		$data['text_filterpro_container'] = $this->language->get('text_filterpro_container');
		$data['text_filterpro_afterload'] = $this->language->get('text_filterpro_afterload');
        ...
        if (isset($this->request->post['filterpro_module'])) {
            $data['modules'] = $this->request->post['filterpro_module'];
        } elseif ($this->config->has('filterpro_module')) {
            $data['modules'] = $this->config->get('filterpro_module');
        } else {
            $data['modules'] = array();
        }
        ...
        if(isset($this->request->post['filterpro_status']) || isset($this->request->post['filterpro_setting'])) {
            $data['filterpro_status'] = $this->request->post['filterpro_status'];
            $data['setting'] = $this->request->post['filterpro_setting'];
        } elseif($this->config->get('filterpro_status')) {
            $data['filterpro_status'] = $this->config->get('filterpro_status');
            $data['setting'] = $this->config->get('filterpro_setting');
        }

		if (!isset($data['setting']['filterpro_container'])) {
			$data['setting']['filterpro_container'] = "list";
		}
		if (!isset($data['setting']['filterpro_afterload'])) {
			$data['setting']['filterpro_afterload'] = "";
		}
